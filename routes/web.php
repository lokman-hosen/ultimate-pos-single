...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/purchases/partial-receive-history/{product_id}/{transaction_id}', [PurchaseController::class, 'partialReceiveHistory'])->name('product.partial.receive.history');;
