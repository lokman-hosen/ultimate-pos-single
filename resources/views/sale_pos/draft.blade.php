...
@section('content')
    ...
    <section class="content-header no-print">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('sale.drafts')</h1>
    </section>
    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <!-- NEW: Summary row above the table -->
            <div class="row" style="margin-bottom:10px;">
                <div class="col-md-12">
                    <h4>Total Amount: <span id="totalAmountSum" style="font-weight:bold;">0.00</span></h4>
                </div>
            </div>
        ...
        $(document).ready( function(){
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "fnDrawCallback": function (oSettings) {
                    ...
                    // Retrieve the total sum from the server response
                    var api = this.api();
                    var total = api.column(5).data().reduce(function (sum, val) {
                        var num = parseFloat(val.replace(/,/g, '')); // if formatted with commas
                        return isNaN(num) ? sum : sum + num;
                    }, 0);
                    $('#totalAmountSum').text(total.toFixed(2));
                }
            });
