...
<head>
    ...
    <style>
        ...
        /* Ensure full height on auth container */
        .container-fluid, .row.eq-height-row, .right-col {
            min-height: 100vh;
        }
        .right-col {
            padding: 0 !important; /* remove default padding to let content fill */
        }
        /* Reset some default styles for better landing */
        .right-col .row {
            margin: 0;
        }
        /* Smooth scrolling */
...
<div class="container-fluid">
    <div class="row eq-height-row">
        <div class="col-md-12 col-sm-12 col-xs-12 right-col tw-pt-20 tw-pb-10 tw-px-5">
            <div class="row">
                {{-- Top-left logo and links --}}
                <div class="tw-absolute tw-top-2 md:tw-top-5 tw-left-4 md:tw-left-8 tw-flex tw-items-center tw-gap-4" style="text-align: left">
                    <a href="{{ url('/') }}">
                        <div class="lg:tw-w-16 md:tw-h-16 tw-w-12 tw-h-12 tw-flex tw-items-center tw-justify-center tw-mx-auto tw-overflow-hidden tw-p-0.5 tw-mb-4">
